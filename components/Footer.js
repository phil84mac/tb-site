...
export default function Footer() {
  ...
  return (
    <>
      ...
      <Container fluid className="mb-4 mb-xl-5 pt-xl-3 pb-5 pb-xl-0">
        <Row className="mt-5 px-xl-5 px-lg-4 px-md-3 mb-xl-4">
          <Col md={12} className="mt-4 pt-5">
            <Row className="align-items-center d-flex mb-5">
              <Col md={6} className="brdr-rght">
                <h2 className="ms-0 my-sm-0 h1 text-dark">
                Remake <br />  your future with us
                </h2>
              </Col>
               <Col md={6} xl={4} className="px-md-5 text-grey">
                 <p className="mb-4">
